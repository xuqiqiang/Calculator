...
public class LogPrinter implements Printer {
    ...
    private void bindService() {
        if (mService != null)
            return;
        Intent intent = new Intent("com.snailstudio.service.logrecorder.LogUtilsService");
        try {
