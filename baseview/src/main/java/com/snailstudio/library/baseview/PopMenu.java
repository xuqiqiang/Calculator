...
public class PopMenu {
    ...
    public PopMenu(Context context, int style) {
        ...
        int layout = R.layout.popmenu;
        if (style == STYLE_BLACK) {
            layout = R.layout.popmenu_black;
        }
        View view = LayoutInflater.from(context).inflate(layout, null);

        if (style == STYLE_BLUE) {
            LinearLayout popmenu_layout = (LinearLayout) view
                    .findViewById(R.id.popmenu_layout);
            ThemeManager mThemeManager = ThemeManager.getInstance();
            if (!mThemeManager.isDefaultTheme()) {
                popmenu_layout
                        .setBackgroundResource(mThemeManager.popmenu_background);
            }
        }
    ...
    private final class PopAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            if (convertView == null) {
                ...
                if (!mThemeManager.isDefaultTheme()) {
                    holder.groupItem
                            .setBackgroundResource(mThemeManager.popmenu_item_bg);
                }
            } else {
